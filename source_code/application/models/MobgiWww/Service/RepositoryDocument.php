 ...
 * Time: 17:57
 */
class MobgiWww_Service_RepositoryDocumentModel{
    ...
    private static function _cookData($data) {
        ...
        if(isset($data['menu_parent_id'])) $tmp['menu_parent_id'] = $data['menu_parent_id'];
    ...
    /**
     *
     * @return MobgiWww_Dao_RepositoryDocumentModel
     */
    private static function _getDao() {
        return Common::getDao("MobgiWww_Dao_RepositoryDocumentModel");
    }
}