 ...
 * Time: 15:55
 */
class MobgiWww_Service_SdkInfoModel{
    ...
    private static function _cookData($data) {
        ...
        if(isset($data['logo_url'])) $tmp['logo_url'] = $data['logo_url'];
    ...
    /**
     *
     * @return MobgiWww_Dao_SdkInfoModel
     */
    private static function _getDao() {
        return Common::getDao("MobgiWww_Dao_SdkInfoModel");
    }
}
