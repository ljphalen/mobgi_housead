 ...
 *
 */
class MobgiApi_Service_InteractiveAdGoodsExchangeLogModel
{

	const DEAFAULT_CONF_TYPE = 0;
	const ANDRIOD_CONF_TYPE = 1;
	const IOS_CONF_TYPE = 2;
	...
	private static function _cookData($data)
	{
		...
		if (isset($data['code_id'])) $tmp['code_id'] = $data['code_id'];
	...
	/**
	 *
	 * @return MobgiApi_Dao_InteractiveAdGoodsExchangeLogModel
	 */
	private static function _getDao()
	{
		return Common::getDao("MobgiApi_Dao_InteractiveAdGoodsExchangeLogModel");
	}
}
