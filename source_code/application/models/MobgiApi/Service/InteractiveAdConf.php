 ...
 *
 */
class MobgiApi_Service_InteractiveAdConfModel
{
	...
	private static function _cookData($data)
	{
		...
		if (isset($data['conf_rel_id'])) $tmp['conf_rel_id'] = intval($data['conf_rel_id']);
	...
	/**
	 *
	 * @return MobgiApi_Dao_InteractiveAdConfModel
	 */
	private static function _getDao()
	{
		return Common::getDao("MobgiApi_Dao_InteractiveAdConfModel");
	}
}
