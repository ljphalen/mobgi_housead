 ...
 *
 */
class MobgiApi_Service_PolymericAdsModel{
	...
	private static function _cookData($data) {
	    ...
	    if(isset($data['third_party_appkey'])) $tmp['third_party_appkey'] = $data['third_party_appkey']; 
	    if(isset($data['position_conf'])) $tmp['position_conf'] = $data['position_conf'];
	...
	/**
	 * 
	 * @return MobgiApi_Dao_PolymericAdsModel
	 */
	private static function _getDao() {
		return Common::getDao("MobgiApi_Dao_PolymericAdsModel");
	}
}
