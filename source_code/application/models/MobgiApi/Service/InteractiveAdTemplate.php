 ...
 *
 */
class MobgiApi_Service_InteractiveAdTemplateModel
{
	...
	private static function _cookData($data)
	{
		...
		if (isset($data['template_name'])) $tmp['template_name'] = $data['template_name'];
	...
	/**
	 *
	 * @return MobgiApi_Dao_InteractiveAdTemplateModel
	 */
	private static function _getDao()
	{
		return Common::getDao("MobgiApi_Dao_InteractiveAdTemplateModel");
	}
}
