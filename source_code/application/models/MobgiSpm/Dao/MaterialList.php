 ...
 * Time: 20:16
 */
class MobgiSpm_Dao_MaterialListModel extends Common_Dao_Base {
    public $adapter = 'mobgiSpm';
    protected $_name = 'material_list';
    ...
    public function getByOr(array $params = array(), array $orderBy = array()){
        $where = Db_Adapter_Pdo::oRsqlWhere($params);
        $sort = Db_Adapter_Pdo::sqlSort($orderBy);
