...
layer.prompt = function (a, b, c) {
    var d = {},
        ...
        e = {
            ...
            success: function () {
                d.prompt = $("#xubox_prompt"),
                d.prompt.focus()
            }
        };
    return 3 === a.type && (e.dialog.msg = '<textarea class="xubox_prompt xubox_form xubox_formArea" id="xubox_prompt">' + (a.val || "") + "</textarea>"),
    $.layer(e)
},
layer.form = function(title,lines,url,beforesubmit,callback){
	var msg = "<table>";
	lines.forEach(function(row)
	{
		msg += "<tr>";
		msg +="<td>"+row.label+":</td><td>"+"<input type='"+row.type+"' class='xubox_prompt xubox_form' id='"+row.id+"' value='"+row.value+"' /></td>";
		msg += "</tr>";
	});
	msg = msg+"</table>";
	var option = {
        ...
        d = {
            ...
            page: {
                ...
                function () {
                    ...
                    "width:" + (a.area[0] || "500px") + "; height:" + (a.area[1] || "300px") + '">'
            ...
            success: function (a) {
                ...
                b.on("click", function () {
                        var a = $(this),
                            b = a.index();
                        a.addClass("xubox_tabnow").siblings().removeClass("xubox_tabnow"),
...
layer.photos = function (a) {
    ...
    if (a = a || {}, b = {
        ...
        if (f = d.data, 1 !== d.status) return layer.msg("未请求到数据", 2, 8),
        void 0;
        if (b.imgLen = f.length, !(f.length > 0)) return layer.msg("没有任何图片", 2, 8),
        void 0;
        b.thissrc = f[d.start].src,
        b.pid = f[d.start].pid,
        b.imgsname = d.title || "",
        b.name = f[d.start].name,
        b.imgIndex = d.start + 1
    } else g = $(e.parent).find("img"),
    h = g.eq(e.start),
    b.thissrc = h.attr("layer-img") || h.attr("src"),
    b.pid = h.attr("pid"),
    b.imgLen = g.length,
    b.imgsname = e.title || "",
    b.name = h.attr("alt"),
    b.imgIndex = e.start + 1;
    return i = {
        type: 1,
        border: [0],
        ...
        success: function (a) {
            b.bigimg = a.find(".xubox_bigimg"),
            b.imgsee = b.bigimg.find(".xubox_imgsee"),
            b.imgbar = b.imgsee.find(".xubox_imgbar"),
            b.imgtit = b.imgbar.find(".xubox_imgtit"),
            b.layero = a;
            var c = b.imgs = b.bigimg.find("img");
            clearTimeout(b.timerr),
            b.timerr = setTimeout(function () {
                $("html").css("overflow", "hidden").attr("layer-full", b.index)
            }, 10),
            c.load(function () {
                b.imgarea = [c.outerWidth(), c.outerHeight()],
                b.resize(a)
            }),
            b.event()
        },
    ...
    b.event = function () {
        ...
        i.imgprev = function () {
            b.imgIndex--,
            b.imgIndex < 1 && (b.imgIndex = b.imgLen),
            b.tabimg()
        },
        ...
        i.imgnext = function () {
            b.imgIndex++,
            b.imgIndex > b.imgLen && (b.imgIndex = 1),
            b.tabimg()
        },
        ...
        $(document).keyup(function (a) {
            if (!b.end) {
                var c = a.keyCode;
                a.preventDefault(),
                37 === c ? i.imgprev() : 39 === c ? i.imgnext() : 27 === c && layer.close(b.index)
            }
        }),
        b.tabimg = function () {
            var e, h, i, j, k;
            b.imgs.removeAttr("style"),
            d ? (j = f[b.imgIndex - 1], e = j.src, h = j.pid, i = j.name) : (k = g.eq(b.imgIndex - 1), e = k.attr("layer-img") || k.attr("src"), h = k.attr("layer-pid") || "", i = k.attr("alt") || ""),
            b.imgs.attr({
                src: e,
                "layer-pid": h,
                alt: i
            }),
            b.imgtit.find("em").text(b.imgIndex + "/" + b.imgLen),
            b.imgsee.show(),
            a.tab && a.tab({
                pid: h,
                name: i
    ...
    b.resize = function (d) {
        var g, e = {},
            f = [c.width(), c.height()];
        e.limit = f[0] - f[0] / f[1] * (60 * f[0] / f[1]),
        e.limit < 600 && (e.limit = 600),
        g = [e.limit, f[1] > 400 ? f[1] - 50 : 400],
        g[0] = a.html ? g[0] : g[0] - 300,
        layer.area(b.index, {
                width: g[0] + (a.html ? 15 : 0),
                height: g[1]
            }),
        e.flwidth = g[0] - (a.html ? 300 : 0),
        b.imgarea[0] > e.flwidth ? b.imgs.css({
                width: e.flwidth
            }) : b.imgs.css({
                width: b.imgarea[0]
            }),
...
layer.photosPage = function (a) {
    ...
    a = a || {},
    $(a.parent).find("img").each(function (a) {
