...
abstract class Util_Http_Base {
	 ...
	 * @param int $timeout
	 */
	public function __construct($url = '', $timeout = 20000) {
		$this->url = $url;
	...
	public function getData() {
		if ($this->dataType == 'json') return json_encode($this->data);
	...
	public function setDataType($type) {
		if (!in_array($type, array('json', 'query'))) return false;
		$this->dataType = $type;
	}
}