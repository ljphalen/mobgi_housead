...
class Util_Smtp {
	...
	function __construct($relay_host = "", $smtp_port = 25, $auth = false, $user, $pass) {
		...
		//$this->log_file = "../../log/sendmail.log";
		$this->sock = FALSE;
	}
	 ...
	 * @param unknown_type $from 发送方邮件地址
	 * @param unknown_type $fromname 发送者姓名
	 * @param unknown_type $subject  邮件主题
	 * @param unknown_type $body  邮件内容
	 * @param unknown_type $mailtype 邮件类型，HTML或TXT
	...
	function sendmail($to, $from, $fromname, $subject = "", $body = "", $mailtype, $cc = "", $bcc = "", $additional_headers = "") {
		...
		$header .= "From:".(('' == $fromname)?$from:$fromname)."<" . $from . ">\r\n";		
