...
class ReportApiGdt(ReportApiBase):
    ...
    def getRemoteData(self):
        ...
        oldMapConf = {
            u'1000811043616572': u'MC45ODI3MDcwMCAxNDYxNjc-NTExMGJl',
            u'3090710034800260': u'MC4yODg3ODcwMCAxNDYxNjc-NTExMGJl',
            u'9080811065243320': u'MC43ODAwODQwMCAxNDYxNjc-NTExMGJl'
        }
        self.mapPoskeyList = dict(self.mapPoskeyList, **oldMapConf)
        oldMapAppConf = {
            u'1000811043616572': u'5110be2586e884a9bc61',
            u'3090710034800260': u'5110be2586e884a9bc61',
            u'9080811065243320': u'5110be2586e884a9bc61'
        }
        self.mapAppkeyList = self.explainThirdMapConf()
        self.mapAppkeyList = dict(self.mapAppkeyList, **oldMapAppConf)
        appResult = {}
        ...
        for val in returnResult:
            ...
            if self.mapAppkeyList.has_key(siteId):
                ...
                if val['PlacementType'] not in ad_type:
                    intergration_type = configApi.AD_TYPE_PIC
                else:
                    intergration_type = ad_type[val['PlacementType']]
