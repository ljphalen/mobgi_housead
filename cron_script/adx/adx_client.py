...
class AdxClient(AdxQbase):
    def init(self):
        self.rq = self.initRedis(configRedis.REDIS_QUEUE_ADX)
        self.rkey = configAdx.RQ_ADX_CLIENT_DATA
        self.dbConfStat = configDb.MYSQL_MOBGI_ADX_STAT
        self.table = configAdx.TABLE_CLIENT_STAT
        self.fields = configAdx.FIELDS_CLIENT_STAT
